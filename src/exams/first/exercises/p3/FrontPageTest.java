package exams.first.exercises.p3;

/**
 * Насловна страница Problem 3
 * Весникот FINKI Onion се одлучил да развие мобилна апликација за своите вести. Сите вести NewsItem се состојат од наслов, датум на објавување (објект од класата java.util.Date) и категорија.
 * Категоријата на вести е објект од класата Category во која се чува само името на категоријата. Две категории се еднакви, ако се еднакви нивните имиња.
 * <p>
 ...
 * List<NewsItem> listByCategoryName(String category) - прима еден аргумент String името на категоријата и враќа листа со сите вести од категоријата со тоа име.
 * Ако не постои категорија со вакво име во полето со категории, да се фрли исклучок од тип CategoryNotFoundException во кој се пренесува името на категоријата која не е најдена.
 ...
 * 15
 * There is the slow-motion crackup of electronics showroom Best Buy. There is Amazon’s rumored entry into the wine business, which is already agitating competitors.
 * And there is the merger of Random House and Penguin, an effort to create a mega-publisher sufficiently hefty to negotiate with the retailer on equal terms.
 * 0
 * Chinese Messaging App Gains Ground Elsewhere
 * 28
 * Chinese Internet companies have long struggled to establish their products beyond the country’s borders. In 2007 China’s dominant search engine,
 * Baidu, announced an ambitious plan to break into the Japanese search engine market; as of last year, the company said it had lost more than $108 million trying.
 * 1
